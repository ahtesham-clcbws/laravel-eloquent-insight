            ...
            <div class="col-lg-6">
                <div class="panel panel-default m-t-15">
                    <div class="card-header">
                        <h5> Add Privacy Policy PDF:</h5>
                    </div>
                    <div class="panel-body">
                        <div class="card alert">
                            <div class="card-body">
                                <form action="{{ route('admin.privacyPolicySave') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col">
                                            ...
                                            <select name="type" class="form-select text-center" id="couponCode">
                                                ...
                                                <option value="website" selected="selected">Website Privacy Policy</option>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="{{ route('admin.privacyPolicyDelete', ['id' => $pros->id]) }}">
...
<script>
    $('.toggle-status').on('change', function() {
        ...
        $.ajax({
            url: "{{ route('privacyPolicyToggleStatus.status') }}",
            method: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
                id: courseId,
