                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="2" class="userImageCell">
                                                <img id="profile_img" src="{{asset('/upload/corporate')}}" style="width:80px;height:80px;border:1px solid #c2c2c2;  ">
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="coupons-container">
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group" style="margin-bottom:0px">
                                        <div class="row institudeCouponGrid" data-couponremain="{{ $remainCoupon}}">
                                            <div class="col">
                                            ...
                                            <div class="col" data-issuedcount="{{$coupon->issued_count}}">
                                                Issued Count: <b>{{$coupon->issued_count}}</b>
                                            </div>
                                            <div style="border:1px solid #8b8b8b" class="my-2"></div>
                                            <div class="row corporate-issued-count-count" data-corporateissuedcount="{{$corporateCountIssued}}" data-corporatename="{{$corporate->name}}" style="display: block;">

                                               <b> {{$corporate->name }}: </b> Total Issued: <b>{{$corporateCountIssued}}</b>
                                    ...
                                    <div class="institute-coupon-grid-content-input" style="display: none;">
                                        <div class="input-group input-group-lg m-3">
                                            ...
                                            <div class="input-group-append" style="width:15%">
                                                <button data-remaincount="{{ $remainCoupon}}" data-prefix="{{$coupon->prefix}}" data-corporate="{{$corporate->id}}" class="btn btn-lg apply-btn">Apply</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
