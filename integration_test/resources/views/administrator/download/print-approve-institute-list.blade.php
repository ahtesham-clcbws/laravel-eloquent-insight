...
<table style="width:100%;"> 
    <tr>
        <td style="width:25%;float:left;">Apprve Institute <br>List</td>
        <td style="width:50%"><center><img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(public_path('/upload/main-logo.jpeg'))) }}" style="width:250px;"></center></td>
...
<table id="customers" style="width:95%;">
  ...
  @foreach ($institute as $institutes)    
    <tr>
        ...
        <td>
                    {{ date('d/m/Y h:i:s A', strtotime($institutes->created_at)) }}
        </td>
