                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-7 mx-auto">
                                                                            <div class="email-container">
                                                                                <h4 class="mb-4" style="font-weight: bold">Compose New Email</h4>
                                                                                <hr>
                                                                                <form action="{{ route('enquiry.replymail') }}" method="POST" enctype="multipart/form-data">
                                                                                    @csrf
                                                                                    <div class="form-group">
                                                                                        <label for="emailTo">To:</label>
                                                                                        <input type="email" name="emailto" class="form-control" id="emailTo" placeholder="Enter recipient email">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="emailCc">Cc:</label>
                                                                                        <input type="email" name="emailcc" class="form-control" id="emailCc" placeholder="Enter cc email">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="emailSubject">Subject:</label>
                                                                                        <input type="text" class="form-control" name="emailsubject" id="emailSubject" placeholder="Enter subject">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="emailBody">Message:</label>

                                                                                        <textarea id="editor" name="title"></textarea>
                                                                                        <div id="wordCount"></div> <!-- Display word count here -->
                                                                                    </div>
                                                                                    <div class="form-group">
