            ...
            <div class="panel panel-default m-t-15">
                ...
                <div class="panel-body">
                    <div class="card alert">
                        <div class="card-body">
                            <form action="{{ route('course.savecategory') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <p class="text-muted m-b-15 f-s-12">Add New Course Category/Class.</p>
                                    <input type="text" name="category" class="form-control input-focus"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('courses.subcategorybyid', ['id' => $category->id]) }}">
                                        <button class="btn btn-xs btn-primary textwhite"><span class="fa fa-plus"></span> Section</a></button>
