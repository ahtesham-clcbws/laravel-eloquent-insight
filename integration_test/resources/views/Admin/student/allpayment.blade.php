...
@section('breadcrumb')
    <ol class="breadcrumb text-right">
        ...
        <li><a href="{{ route('course.category') }}">Payment List</a></li>
    </ol>
@endsection
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       @foreach($paymentList as $paymentLists)
                                       <tr>
                                        <th scope="row">{{ $loop->iteration }}</th>

                                        <td>{{ $paymentLists->id }}</td>
                                        <td>{{ $paymentLists->user_email }}</td>
                                        <td>9155494233</td>
                                        <td>{{ $paymentLists->r_payment_id }}</td>
                                        <td>{{ $paymentLists->method }}</td>
                                        <td class="color-primary">{{ $paymentLists->amount }}</td>
