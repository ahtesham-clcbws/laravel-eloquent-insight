        ...
        <center>
            <table style="border-collapse:collapse;margin-left:6.3494pt" cellspacing="0">
                ...
                <tr style="height:24pt">
                    ...
                    <td style="width:133pt;" class="tb1">
                        <p class="s10 sansita" style="padding-top: 7pt;padding-left: 10pt;text-indent: 0pt;text-align: left;"> {{$student->scholarship_category ?? 'NA'}}</p>
                    </td>
                </tr>
                <tr style="height:25pt">
                    <td style="width:93pt;" class="tb1">
                    ...
                    <td style="width:133pt;" class="tb1">
                        <p class="s10" style="padding-top: 8pt;padding-left: 13pt;text-indent: 0pt;text-align: left;">{{$student->scholarship_opted_for ?? 'NA'}}</p>
                    </td>
                </tr>
                ...
                <tr style="height:24pt">
                    ...
                    <td style="width:129pt;" class="tb1">
                        <p class="s10" style="padding-top: 6pt;padding-left: 13pt;text-indent: 0pt;text-align: left;">21st
                            July 2024</p>
                    </td>
                    <td style="width:75pt;" class="tb1">
                    ...
                    <td style="width:133pt;" class="tb1">
                        <p class="s10" style="padding-top: 6pt;padding-left: 12pt;text-indent: 0pt;text-align: left;">9.00
                            AM - 11.00 AM (2 Hrs)</p>
                    </td>
                ...
                <tr style="height:25pt">
                    ...
                    <td style="width:337pt;" class="tb1" colspan="3">
                        <p class="s10" style="padding-top: 9pt;padding-left: 14pt;text-indent: 0pt;text-align: left;">
                            US Fake Address in New York Generator provide random United States-200235</p>
                    </td>
                </tr>
                <tr style="height:25pt">
                    <td style="width:93pt;" class="tb1">
                        <p class="s10" style="padding-top: 10pt;padding-left: 12pt;text-indent: 0pt;text-align: left;">
                            District / City/ State</p>
                    </td>
                    <td style="width:129pt;" class="tb1">
                        <p class="s10" style="padding-top: 10pt;padding-left: 12pt;text-indent: 0pt;text-align: left;">
                            Ghaziabad, UP - 201006</p>
                    </td>
                    <td style="width:75pt;" class="tb1">
