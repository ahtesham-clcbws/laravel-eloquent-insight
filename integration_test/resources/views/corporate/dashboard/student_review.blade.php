...
<div class="container pagecontentbody">
   <div class="tab-content">
      <div class="pagebody p-4">
         <div class="row">
            <div class="col-md-9">
               <a class="btn btn-info float-left Exam" href="{{route('studentDashboard')}}" style="width: 6rem;
    height: 2.65rem;">
            ...
            <div class="col-md-3">
               <div align="center" class="col-md-2 d-grid">
                  <button type="button" style="width: 6rem;height: 2.65rem;" class="btn btn-md btn-info" data-print="modal" onclick="PrintDoc()"> Print </button>
                        ...
                        <table class="bsvtbl" border="0" cellspacing="0" cellpadding="8" width="100%" style="border-collapse:collapse;">
                           ...
                           <tbody>
                              ...
                              <td>
                                 ...
                                 <td>
                                 <input type="hidden" name="choiceCenterA_checked" value="0"> <input title="Please Tick" type="checkbox" name="choiceCenterA_checked" class="form-check-input" id="choiceCenterA_checked" value="1" {{ $student->choiceCenterA_checked ? 'checked' : '' }} required>
                              ...
                              <tr>
                                 <td colspan="4">
                                    <b>I agree for Career without Barrier’s Terms & Conditions</b> &nbsp;&nbsp;  @if($student->terms_conditions) &check; @else No @endif
                                 </td>
                              </tr>
                           </tbody>
                        </table>
