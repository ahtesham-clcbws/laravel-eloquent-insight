<div class="h-100">
    ...
    <div class="d-flex justify-content-between align-items-baseline p-4 pb-0">
        <div>
            <h4>Discount Voucher Details: {{$corporate->institute_name}}</h4>
            <p class="mb-0">
                {{ $corporate->district?->name }}, {{ $corporate->state?->name }}
            </p>
        </div>
        <a class="btn btn-sm btn-warning" href="{{ route('institute.view', $corporate->id) }}">Back to Institute</a>
    </div>
    <div class="row">
